...
pub const MODAL_UPDATE: &str = concat!(env!("CARGO_MANIFEST_DIR"), "/assets/modal_update.svg");
pub const PANEL_LEFT_OPEN: &str =
    concat!(env!("CARGO_MANIFEST_DIR"), "/assets/panel_left_open.svg");
