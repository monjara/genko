    ...
    pub fn bind_keys(cx: &mut App) {
        cx.bind_keys([
            ...
            KeyBinding::new(
                "escape",
                VimNormalMode,
                Some("Genko && vim_mode == operator_delete"),
            ),
            KeyBinding::new(
                "escape",
                VimNormalMode,
                Some("Genko && vim_mode == operator_change"),
            ),
            KeyBinding::new(
                "escape",
                VimNormalMode,
                Some("Genko && vim_mode == operator_delete_inner"),
            ),
            KeyBinding::new(
                "escape",
                VimNormalMode,
                Some("Genko && vim_mode == operator_delete_around"),
            ),
            KeyBinding::new(
                "escape",
                VimNormalMode,
                Some("Genko && vim_mode == operator_change_inner"),
            ),
            KeyBinding::new(
                "escape",
                VimNormalMode,
                Some("Genko && vim_mode == operator_change_around"),
            ),
            KeyBinding::new("v", VimVisualMode, Some("Genko && vim_mode == normal")),
            KeyBinding::new("v", VimNormalMode, Some("Genko && vim_mode == visual")),
            KeyBinding::new("d", VimDeleteOperator, Some("Genko && vim_mode == normal")),
            KeyBinding::new("c", VimChangeOperator, Some("Genko && vim_mode == normal")),
            KeyBinding::new(
                "i",
                VimTextObjectInner,
                Some("Genko && vim_mode == operator_delete"),
